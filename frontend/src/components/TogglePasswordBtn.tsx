...
}: HideShowPasswordBtnProps) => {
  return (
    <button
      className="absolute right-1 top-1/2 -translate-y-1/2 h-8 w-8 flex items-center justify-center bg-transparent focus:outline-none "
      type="button"
